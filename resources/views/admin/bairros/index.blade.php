		...
		<div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabela de Bairros</h3>
         	</div>
					 ...
					 <div class="box-body">
								<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
									<div class="col-sm-12">
											...
											<tbody>
												@foreach($registros as $registro)
													<tr role="row" class="odd">
														...
														<td>{{ $registro->nome }}</td>
															<td>
																<a class="fa-btn label label-success" href="{{route('admin.bairros.editar', $registro->id)}}">Editar</a>
																<a class="fa-btn label label-danger" href="javascript: if(confirm('Deletar esse registro?')){ window.location.href = '{{ route('admin.bairros.deletar',$registro->id) }}' }">Deletar</a>
										...
										<div> <!--botao inserir-->
											<a class="btn btn-primary" href="{{route('admin.bairros.adicionar')}}">Adicionar</a>
										</div>
									</div>
								</div>
							</div>
