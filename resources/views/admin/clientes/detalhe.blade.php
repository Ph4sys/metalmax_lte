	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="col-sm-12">
						<table id="TableContatos" class="table table-bordered table-hover dataTable" style="width:100%">
							<thead>
								<tr role="row">
	...
	@if($cliente->tipo_envio == 'Transportadora')
		...
		<div class="box-body">
			<table id="tableTransportadoras" class="table table-bordered table-hover dataTable">
				...
				<div>
					<a class="btn btn-primary" href="{{route('admin.contatos.adicionar',$cliente->id)}}">Adicionar Transportadora</a>
				</div>
			</div>
		</div>
	</div>
