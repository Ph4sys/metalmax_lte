		...
		<div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabela de Cidades</h3>
         	</div>
					 <div class="box-body">
										...
										<tbody>
											@foreach($registros as $registro)
												<tr role="row" class="odd">
													...
													<td>{{ $registro->nome }}</td>
														<td>
															<a class="fa-btn label label-success" href="{{route('admin.cidades.editar', $registro->id)}}">Editar</a>
															<a class="fa-btn label label-danger" href="javascript: if(confirm('Deletar esse registro?')){ window.location.href = '{{ route('admin.cidades.deletar',$registro->id) }}' }">Deletar</a>
														</td>
												</tr>
											@endforeach
										</tbody>
