...
<div class="container">
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="col-sm-12">
						<table id="TableHContatos" class="table table-bordered table-hover dataTable" style="width:100%">
							<thead>
								<tr role="row">
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="col-sm-12">
						<table id="TableHContacoes" class="table table-bordered table-hover dataTable" style="width:100%">
							<thead>
								<tr role="row">
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Histórico Pedidos (Internos)</h3>
			</div>

			<div class="box-body">
				<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="col-sm-12">
						<table id="TableHPedidos" class="table table-bordered table-hover dataTable" style="width:100%">
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Nome: activate to sort column ascending">Ordem Compra</th>
